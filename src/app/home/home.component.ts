...
export class HomeComponent {
  ...
  galleryItems: WritableSignal<GalleryItems[]> = signal<GalleryItems[]>([
    ...
    },
    {
      ...
      name: 'Pinterest Inspired Skecth',
    ...
    },
    {
      ...
      name: 'Taylor Swift Aesthetic Sketch',
    ...
    },
    {
      ...
      name: 'Snoopy Wearing Harry Potter Uniform Doodle',
      tag: ['Doodles'],
    },
    {
      id: 78,
